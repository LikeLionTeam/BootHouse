...
public class UserAuth {
    ...
    @Builder
    public UserAuth(Long id, User user, Course course, AuthRequestType authRequestType, AuthRequestStatus authRequestStatus, LocalDateTime determined_at, byte[] image, String imageUrl) {
        this.id = id;
        this.user = user;
        this.course = course;
